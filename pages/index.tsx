      ...
      <Row className="align-items-center min-vh-75">
        <Col lg="6" className="text-center text-lg-start">
          ...
          <p className="lead mb-4">
            ...
            React 18, and the latest web technologies. Perfect for enterprise applications.
          </p>
  ...
  const features = [
    {
      ...
      description: 'Built with Next.js 14 and React 18 for optimal performance and user experience.'
    },
    {
    ...
    },
    {
      icon: 'fas fa-palette',
      title: 'Modern UI/UX',
      description: 'Beautiful, modern interface with Preline UI components and smooth animations.'
    },
    {
      icon: 'fas fa-cogs',
      title: 'Easy Customization',
      description: 'Highly customizable with centralized configuration and modular architecture.'
    },
    {
      icon: 'fas fa-chart-bar',
      title: 'Analytics Ready',
      description: 'Built-in analytics, charts, and reporting capabilities for data-driven decisions.'
    }
  ];
    ...
    <section className="features-section py-5">
      <Container>
        <Row className="text-center mb-5">
          <Col>
            <h2 className="display-5 fw-bold mb-3">Why Choose Our Dashboard?</h2>
    ...
    <Container>
      <Row className="text-center">
        <Col>
          ...
          <p className="lead mb-4">
            Join thousands of users who trust our dashboard for their business needs.
          </p>
          <Button 
            color="light" 
            size="lg" 
      ...
      <Row>
        <Col md="6" className="mb-4 mb-md-0">
          ...
          <p className="text-muted mb-3">
            A modern, responsive dashboard built with the latest web technologies 
        ...
        <Col md="3" className="mb-4 mb-md-0">
          ...
          <ul className="list-unstyled">
            <li className="mb-2">
              <Link href="/admin/dashboard" className="text-muted text-decoration-none">
                Dashboard
              </Link>
            </li>
            <li className="mb-2">
              <Link href="/admin/profile" className="text-muted text-decoration-none">
                Profile
              </Link>
            </li>
            <li className="mb-2">
              <Link href="/admin/tables" className="text-muted text-decoration-none">
                Tables
              </Link>
            </li>
            <li className="mb-2">
              <Link href="/admin/maps" className="text-muted text-decoration-none">
                Maps
              </Link>
            </li>
          </ul>
        ...
        <Col md="3">
          ...
          <ul className="list-unstyled">
            <li className="mb-2">
              <Link href="/auth/login" className="text-muted text-decoration-none">
                Login
              </Link>
            </li>
            <li className="mb-2">
              <Link href="/auth/register" className="text-muted text-decoration-none">
                Register
              </Link>
            </li>
            <li className="mb-2">
      ...
      <Row className="align-items-center">
        <Col md="6">
          <p className="text-muted mb-0">
            © {new Date().getFullYear()} NextJS Enterprise Dashboard. All rights reserved.
          </p>
        </Col>
