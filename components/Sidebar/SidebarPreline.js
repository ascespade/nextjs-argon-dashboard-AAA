...
function SidebarPreline({ routes, logo }) {
  ...
  return (
    <>
      <nav
        className={`hs-sidebar hs-sidebar-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden lg:block lg:translate-x-0 lg:end-auto lg:bottom-0 lg:z-50 lg:bg-white lg:border-e lg:border-gray-200 lg:pt-0 lg:pb-0 lg:overflow-y-auto lg:flex lg:flex-col lg:fixed lg:top-0 lg:start-0 ${
                    ...
                    return (
                      <li key={key}>
                        ...
                        >
                          {prop.icon && (
                            <i
                              className={`${prop.icon} flex-shrink-0 size-4`}
                            />
                          )}
                          {prop.name}
                        </Link>
