...
const AdminFooterPreline: React.FC = () => {
  const currentYear = new Date().getFullYear();

  return (
    <footer className='bg-white border-t border-gray-200 dark:bg-neutral-800 dark:border-neutral-700'>
...
export default AdminFooterPreline;
