...
const Sidebar: React.FC = () => {
  ...
  return (
    ...
    >
        ...
        <ul className='space-y-1'>
          <li>
            ...
            >
              ...
              >
                <path
                  d='M3 13h8V3H3v10zm10 8h8v-6h-8v6zM13 3v6h8V3h-8zM3 21h8v-6H3v6z'
                  fill='currentColor'
                />
              </svg>
          ...
          <li>
            ...
            >
              ...
              >
                <path
                  d='M12 12c2.761 0 5-2.239 5-5s-2.239-5-5-5-5 2.239-5 5 2.239 5 5 5zM4 21v-1c0-2.761 4.477-5 8-5s8 2.239 8 5v1H4z'
                  fill='currentColor'
                />
              </svg>
              <span className={`nav-label ${collapsed ? 'sr-only' : 'block'}`}>
      ...
      <div className='p-3'>
        <button className='w-full text-sm text-left text-gray-600 hover:text-gray-900'>
          Settings
        </button>
      </div>
    </aside>
