...
export default function HomeEditorClient({
  ...
  const renderComponent = (component: Component) => {
    ...
    const isEditing =
      isEditMode && editorState.editingComponent === component.id;
            ...
            <div className='max-w-5xl mx-auto px-4 text-center'>
              {isEditing ? (
                <input
                  ...
                  onChange={e =>
                    handleInlineEdit(component.id, 'title', {
                      ...props.title,
              ...
              {isEditing ? (
                <textarea
                  ...
                  onChange={e =>
                    handleInlineEdit(component.id, 'subtitle', {
                      ...props.subtitle,
                      [isRTL ? 'ar' : 'en']: e.target.value,
                    })
                  }
