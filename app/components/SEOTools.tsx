...
export default function SEOTools({ seoData, content, onUpdateSEO, isOpen, onClose }: SEOToolsProps) {
    const { t } = useI18n();
                                            ...
                                            <div>
                                                ...
                                                <div className="space-y-2">
                                                    {analysis.issues.map((issue, index) => (
                                                        <div
                                                            key={index}
                                                            className={`p-3 rounded-lg border-l-4 ${issue.type === 'error'
                                            ...
                                            <div>
                                                ...
                                                <div className="space-y-2">
                                                    {analysis.suggestions.map((suggestion, index) => (
                                                        <div
                                                            key={index}
                                                            className={`p-3 rounded-lg border-l-4 ${suggestion.priority === 'high'
