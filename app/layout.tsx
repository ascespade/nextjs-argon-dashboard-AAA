export const metadata = {
  ...
  description: 'A modern, responsive, and feature-rich dashboard built with Next.js and Tailwind + Preline',
};
  ...
  return (
    <html lang="en">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `!function(){if(typeof window!=='undefined'){var s=document.createElement('script');s.src='https://cdn.tailwindcss.com';s.async=true;document.head.appendChild(s)}}()` }} />
