        ...
        components: [
          {
            ...
            type: 'hero_banner',
            props: {
              title: 'Welcome to Argon Editable',
              subtitle: 'Build pages visually with Argon components.',
          ...
          },
          {
            id: 'text-1',
            type: 'text_block',
            props: { text: 'This homepage content is loaded from the local DB. Switch to edit mode to modify it inline.' },
            layout: {},
            style: {}
          }
        ]
